...
from location_cloaking.utils.map.agents.tools.misc import vector
...
class GlobalRoutePlanner(object):
    ...
    def __init__(self, wmap, sampling_resolution):
        ...
        self._build_graph()
        print("Finding loose ends")
        self._find_loose_ends()
        print("Lane change linkage")
    ...
    def _localize(self, location):
        ...
        try:
            ...
            # print("&", self._road_id_to_edge[waypoint.road_id])
