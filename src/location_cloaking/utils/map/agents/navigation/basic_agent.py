...
from location_cloaking.utils.map.agents.navigation.local_planner import LocalPlanner, RoadOption
from location_cloaking.utils.map.agents.navigation.global_route_planner import GlobalRoutePlanner
from location_cloaking.utils.map.agents.tools.misc import (get_speed, is_within_distance,
...
class BasicAgent(object):
    ...
    def __init__(self, vehicle, target_speed=20, opt_dict={}, map_inst=None, grp_inst=None):
        ...
        self._sampling_resolution = 10.0
